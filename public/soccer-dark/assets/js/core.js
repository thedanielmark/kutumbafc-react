  ...
  !(function (i) {
    var n = new Array(),
      ...
      l = function () {
        ...
        if (
          (i(jBar)
            .stop()
            .animate({ width: t + "%" }, 500, "linear"),
          a.showPercentage && i(jPer).text(t + "%"),
          e >= n.length)
        ) {
          if (
            ((e = n.length),
            ...
            a.showPercentage && i(jPer).text("100%"),
            a.debugMode)
          )
            c();
          i(jBar)
    ...
    i.fn.jpreLoader = function (t, e) {
      return (
        ...
        i("body").css({ display: "block" }),
        this.each(function () {
          !(function () {
            if (a.onetimeLoad) {
              for (
                var t, e = document.cookie.split("; "), i = 0;
                (t = e[i] && e[i].split("="));
                i++
              )
            ...
            ? ((function () {
                if (
                  ...
                  i(jContent).css({
                    ...
                    i(jContent).html(
                      i(a.splashID).wrap("<div/>").parent().html()
                    ),
                    i(a.splashID).remove(),
                    a.splashFunction();
                }
              ...
              i(this)
                ...
                .each(function () {
                  var t = "";
                  -1 == i(this).css("background-image").indexOf("none") &&
                  -1 == i(this).css("background-image").indexOf("-gradient") &&
                  -1 == i(this).css("background-image").indexOf("svg")
                    ? -1 !=
                        (t = i(this).css("background-image")).indexOf("url") &&
                      (t = t.match(/url\((.*?)\)/)[1].replace(/\"/g, ""))
                    : "img" == i(this).get(0).nodeName.toLowerCase() &&
                      void 0 !== i(this).attr("src") &&
                      (t = i(this).attr("src")),
                    0 < t.length && n.push(t);
                }),
              (function () {
      ...
      (o = 0),
        ...
        (a.prototype.checkResponsive = function (t, e) {
          ...
          if (
            ("window" === r.respondTo
              ...
              : "slider" === r.respondTo
              ? (o = s)
              : "min" === r.respondTo && (o = Math.min(l, s)),
        ...
        (a.prototype.getLeft = function (t) {
          ...
          return (
            ...
            r.slideCount <= r.options.slidesToShow && (a = r.slideOffset = 0),
            !0 === r.options.centerMode &&
            r.slideCount <= r.options.slidesToShow
              ? (r.slideOffset =
          ...
          return (
            (t =
              !0 === a.options.centerMode
                ? Math.floor(a.$list.width() / 2)
                : 0),
            (r = -1 * a.swipeLeft + t),
            !0 === a.options.swipeToSlide
              ? (a.$slideTrack.find(".slick-slide").each(function (t, e) {
                  var i, n;
                  if (
                    ((i = d(e).outerWidth()),
                    (n = e.offsetLeft),
                    !0 !== a.options.centerMode && (n += i / 2),
                    r < n + i)
                  )
                    return (o = e), !1;
                }),
                Math.abs(d(o).attr("data-slick-index") - a.currentSlide) || 1)
        ...
        (a.prototype.lazyLoad = function () {
          ...
          if (
            ...
            for (
              var o = i - 1, a = n, s = r.$slider.find(".slick-slide"), l = 0;
              l < r.options.slidesToScroll;
              l++
            )
              o < 0 && (o = r.slideCount - 1),
                (e = (e = e.add(s.eq(o))).add(s.eq(a))),
                o--,
                a++;
          t(e),
            r.slideCount <= r.options.slidesToShow
        ...
        (a.prototype.removeSlide = a.prototype.slickRemove = function (
          t,
          e,
          i
        ) {
          ...
          if (
            ...
            0 <= t && t <= r.slideCount - r.options.slidesToShow
              ...
              : ((o = r.slideCount % r.options.slidesToShow),
                (n =
                  !0 === r.options.infinite ? r.options.slidesToShow + t : t),
        ...
        (a.prototype.swipeMove = function (t) {
          ...
          return (
            ...
            !(!s.dragging || s.scrolling || (r && 1 !== r.length)) &&
              ...
              !s.options.verticalSwiping && !s.swiping && 4 < a
                ? !(s.scrolling = !0)
    ...
    (function (t, e) {
      ...
      function f(t, e) {
        if (e) {
          ...
          for (var o = e.cloneNode(!0); o.childNodes.length; )
              ...
              if (n && /svg/i.test(n.nodeName)) {
                ...
                if (d && (!c.validate || c.validate(o, n, i))) {
                  ...
                  if (a.length) {
                    var l = u[a];
                    l ||
                      ((l = u[a] = new XMLHttpRequest()).open("GET", a),
                      l.send(),
                      (l._embeds = [])),
                      l._embeds.push({ svg: n, id: s }),
                      g(l);
              ...
              e.exports = function (t, e) {
                (this.el = t),
                  ...
                  (this.getDiffDate = function () {
                    ...
                    return (
                      t <= 0
                        ? this.interval && (this.stop(), this.options.onEnd())
                        : (31557600 <= t &&
            ...
            function (t, e, i) {
              ...
              (jQuery.fn.countdown = function (n) {
                return $.each(this, function (t, e) {
                  var i = $(e);
                  i.data(r) ||
                    (i.data("date") && (n.date = i.data("date")),
                    i.data(r, new o(e, n)));
                });
              }),
                (e.exports = o);
    ...
    (function (t, e) {
      ...
      var a = function (t, a) {
          ...
          1 < window.devicePixelRatio &&
            ...
            (e.style.width = e.style.height = [a.size, "px"].join("")),
            (e.width = e.height = a.size * n),
            o.scale(n, n)),
            o.translate(a.size / 2, a.size / 2),
            o.rotate((a.rotate / 180 - 0.5) * Math.PI);
          var r = (a.size - a.lineWidth) / 2;
          a.scaleColor && a.scaleLength && (r -= a.scaleLength + 2),
            (Date.now =
              Date.now ||
              function () {
                return +new Date();
              ...
              a.scaleColor &&
                (function () {
                  ...
                  for (var i = 24; 0 < i; --i)
                    i % 6 == 0
                      ? ((e = a.scaleLength), (t = 0))
                      : ((e = 0.6 * a.scaleLength), (t = a.scaleLength - e)),
                      o.fillRect(-a.size / 2 + t, 0, e, 1),
                      o.rotate(Math.PI / 12);
                  o.restore();
                })(),
          ...
          (this.getCanvas = function () {
              ...
              a.scaleColor || a.trackColor
                ? o.getImageData && o.putImageData
                  ? i
                    ...
                    : (d(), (i = o.getImageData(0, 0, a.size * n, a.size * n)))
                  : (this.clear(), d())
                : this.clear(),
                (o.lineCap = a.lineCap),
                (e =
                  "function" == typeof a.barColor ? a.barColor(t) : a.barColor),
                s(e, a.lineWidth, t / 100);
            }.bind(this)),
            (this.animate = function (i, n) {
              ...
              var r = function () {
                ...
                this.draw(e),
                  a.onStep(i, n, e),
                  t >= a.animate.duration ? a.onStop(i, n) : l(r);
              }.bind(this);
              l(r);
            }.bind(this));
        },
        n = function (e, i) {
          ...
          var o = {},
            r = 0,
            t = function () {
              for (var t in ((this.el = e), (this.options = o), n))
                n.hasOwnProperty(t) &&
                  ((o[t] = i && void 0 !== i[t] ? i[t] : n[t]),
    ...
    (function (t) {
      ...
      var u,
        ...
        w = function (t, e) {
          u.ev.triggerHandler("mfp" + t, e),
            u.st.callbacks &&
              ((t = t.charAt(0).toLowerCase() + t.slice(1)),
              u.st.callbacks[t] &&
                u.st.callbacks[t].apply(u, c.isArray(e) ? e : [e]));
        },
        k = function (t) {
          return (
            (t === e && u.currTemplate.closeBtn) ||
              ((u.currTemplate.closeBtn = c(
                u.st.closeMarkup.replace("%title%", u.st.tClose)
              )),
              (e = t)),
        ...
        r = function () {
          c.magnificPopup.instance ||
            ((u = new t()).init(), (c.magnificPopup.instance = u));
        };
      (t.prototype = {
        constructor: t,
        init: function () {
          ...
          (u.isLowIE = u.isIE8 = document.all && !document.addEventListener),
            (u.isAndroid = /android/gi.test(t)),
            (u.isIOS = /iphone|ipad|ipod/gi.test(t)),
        ...
        open: function (t) {
          ...
          if (!1 === t.isObj) {
            ...
            (u.items = c.isArray(t.items) ? t.items : [t.items]),
              (u.index = t.index || 0);
          if (!u.isOpen) {
            (u.types = []),
              (p = ""),
              t.mainEl && t.mainEl.length
                ...
                : (u.ev = h),
              t.key
                ? (u.popupsCache[t.key] || (u.popupsCache[t.key] = {}),
                  (u.currTemplate = u.popupsCache[t.key]))
                : (u.currTemplate = {}),
              (u.st = c.extend(!0, {}, c.magnificPopup.defaults, t)),
              (u.fixedContentPos =
                "auto" === u.st.fixedContentPos
                  ? !u.probablyMobile
                  : u.st.fixedContentPos),
              u.st.modal &&
                ((u.st.closeOnContentClick = !1),
                (u.st.closeOnBgClick = !1),
                (u.st.showCloseBtn = !1),
                (u.st.enableEscapeKey = !1)),
              u.bgOverlay ||
                ((u.bgOverlay = x("bg").on("click" + m, function () {
                  u.close();
                })),
                (u.wrap = x("wrap")
                  .attr("tabindex", -1)
                ...
                (u.container = x("container", u.wrap))),
              (u.contentContainer = x("content")),
              u.st.preloader &&
                (u.preloader = x("preloader", u.container, u.st.tLoading));
            ...
            w("BeforeOpen"),
              ...
              u.fixedContentPos
                ...
                : u.wrap.css({ top: y.scrollTop(), position: "absolute" }),
              (!1 === u.st.fixedBgPos ||
                ("auto" === u.st.fixedBgPos && !u.fixedContentPos)) &&
                u.bgOverlay.css({ height: h.height(), position: "absolute" }),
            ...
            return (
              u.isIE7 && (d += " mfp-ie7"),
              d && u._addClassToMFP(d),
              u.updateItemHTML(),
              w("BuildControls"),
              c("html").css(s),
              u.bgOverlay
                .add(u.wrap)
                .prependTo(u.st.prependTo || c(document.body)),
              (u._lastFocusedEl = document.activeElement),
              setTimeout(function () {
                u.content
                  ? (u._addClassToMFP(v), u._setFocus())
                  : u.bgOverlay.addClass(v),
                  h.on("focusin" + m, u._onFocusIn);
              }, 16),
              (u.isOpen = !0),
              u.updateSize(a),
              w(g),
        ...
        _close: function () {
          ...
          if (
            ...
            u.wrap.detach(),
            u.container.empty(),
            u.st.mainClass && (t += u.st.mainClass + " "),
            u._removeClassFromMFP(t),
            u.fixedContentPos)
          ) {
            var e = { marginRight: "" };
            u.isIE7 ? c("body, html").css("overflow", "") : (e.overflow = ""),
              c("html").css(e);
          }
          h.off("keyup.mfp focusin" + m),
            u.ev.off(m),
            u.wrap.attr("class", "mfp-wrap").removeAttr("style"),
            u.bgOverlay.attr("class", "mfp-bg"),
            u.container.attr("class", "mfp-container"),
            !u.st.showCloseBtn ||
              (u.st.closeBtnInside && !0 !== u.currTemplate[u.currItem.type]) ||
              (u.currTemplate.closeBtn && u.currTemplate.closeBtn.detach()),
            u.st.autoFocusLast &&
              u._lastFocusedEl &&
              c(u._lastFocusedEl).focus(),
            (u.currItem = null),
            (u.content = null),
            (u.currTemplate = null),
            (u.prevHeight = 0),
        ...
        updateItemHTML: function () {
          ...
          u.contentContainer.detach(),
            ...
            t.parsed || (t = u.parseEl(u.index));
          var e = t.type;
          if (
            (w("BeforeChange", [u.currItem ? u.currItem.type : "", e]),
            (u.currItem = t),
            !u.currTemplate[e])
          ) {
            var i = !!u.st[e] && u.st[e].markup;
            w("FirstMarkupParse", i), (u.currTemplate[e] = !i || c(i));
          }
          o && o !== t.type && u.container.removeClass("mfp-" + o + "-holder");
          var n = u["get" + e.charAt(0).toUpperCase() + e.slice(1)](
            t,
            u.currTemplate[e]
          );
          u.appendContent(n, e),
        ...
        appendContent: function (t, e) {
          (u.content = t)
            ? u.st.showCloseBtn &&
              u.st.closeBtnInside &&
              !0 === u.currTemplate[e]
              ? u.content.find(".mfp-close").length || u.content.append(k())
              : (u.content = t)
            : (u.content = ""),
            w("BeforeAppend"),
            u.container.addClass("mfp-" + e + "-holder"),
        ...
        _openClick: function (t, e, i) {
          if (
            ...
            t.type && (t.preventDefault(), u.isOpen && t.stopPropagation()),
              (i.el = c(t.mfpEl)),
        ...
        updateStatus: function (t, e) {
          if (u.preloader) {
            n !== t && u.container.removeClass("mfp-s-" + n),
              e || "loading" !== t || (e = u.st.tLoading);
            var i = { status: t, text: e };
            w("UpdateStatus", i),
              (t = i.status),
              (e = i.text),
              u.preloader.html(e),
              u.preloader.find("a").on("click", function (t) {
                t.stopImmediatePropagation();
              }),
              u.container.addClass("mfp-s-" + t),
              (n = t);
          }
        },
        ...
        _hasScrollBar: function (t) {
          return (
            (u.isIE7 ? h.height() : document.body.scrollHeight) >
            (t || y.height())
          );
        },
        _setFocus: function () {
        ...
        _onFocusIn: function (t) {
          if (t.target !== u.wrap[0] && !c.contains(u.wrap[0], t.target))
            return u._setFocus(), !1;
        },
        ...
        _getScrollbarSize: function () {
          if (void 0 === u.scrollbarSize) {
            ...
            (t.style.cssText =
              ...
              (u.scrollbarSize = t.offsetWidth - t.clientWidth),
        ...
        (c.fn.magnificPopup = function (t) {
          ...
          if ("string" == typeof t)
            if ("open" === t) {
              var i,
                n = s ? e.data("magnificPopup") : e[0].magnificPopup,
              ...
              n.items
                ...
                : ((i = e),
                  ...
                  (i = i.eq(o))),
                u._openClick({ mfpEl: i }, e, n);
            } else
              u.isOpen &&
                u[t].apply(u, Array.prototype.slice.call(arguments, 1));
          else
            (t = c.extend(!0, {}, t)),
              s ? e.data("magnificPopup", t) : (e[0].magnificPopup = t),
              u.addGroup(e, t);
          return e;
        });
      var S,
          ...
          getInline: function (t, e) {
            if ((M(), t.src)) {
              ...
              if (n.length) {
                ...
                o &&
                  o.tagName &&
                  (C || ((S = i.hiddenClass), (C = x(S)), (S = "mfp-" + S)),
                  (T = n.after(C).detach().removeClass(S))),
      ...
      c.magnificPopup.registerModule(P, {
        ...
        proto: {
          ...
          getAjax: function (o) {
            _ && c(document.body).addClass(_), u.updateStatus("loading");
            var t = c.extend(
              {
                url: o.src,
                ...
                error: function () {
                  A(),
                    ...
                    u.updateStatus(
                      "error",
                      u.st.ajax.tError.replace("%url%", o.src)
                    );
                },
              },
              u.st.ajax.settings
        ...
        proto: {
          ...
          _onImageHasSize: function (t) {
            t.img &&
              ...
              w("ImageHasSize", t),
              t.imgHidden &&
                (u.content && u.content.removeClass("mfp-loading"),
                (t.imgHidden = !1)));
          },
            ...
            var i = 0,
              n = function () {
                t &&
                  (t.img[0].complete
                    ? (t.img.off(".mfploader"),
                      t === u.currItem &&
                        (u._onImageHasSize(t), u.updateStatus("ready")),
                      (t.hasSize = !0),
                      (t.loaded = !0),
                      w("ImageLoadComplete"))
                    : ++i < 200
              ...
              o = function () {
                t &&
                  ...
                  t === u.currItem &&
                    (u._onImageHasSize(t),
                    u.updateStatus("error", r.tError.replace("%url%", t.src))),
                  (t.hasSize = !0),
                  (t.loaded = !0),
                  (t.loadError = !0));
              },
            ...
            if (a.length) {
              ...
              (s.className = "mfp-img"),
                t.el &&
                  ...
                  (s.alt = t.el.find("img").attr("alt")),
                (t.img = c(s).on("load.mfploader", n).on("error.mfploader", o)),
                (s.src = t.src),
                a.is("img") && (t.img = t.img.clone()),
                0 < (s = t.img[0]).naturalWidth
                  ? (t.hasSize = !0)
                  : s.width || (t.hasSize = !1);
            }
            return (
                ...
                ? (O && clearInterval(O),
                  t.loadError
                    ? (e.addClass("mfp-loading"),
                      u.updateStatus("error", r.tError.replace("%url%", t.src)))
                    : (e.removeClass("mfp-loading"), u.updateStatus("ready")))
        ...
        proto: {
          ...
          _getOffset: function (t) {
            var e,
              i = (e = t
                ? u.currItem.img
                : u.st.zoom.opener(u.currItem.el || u.currItem)).offset(),
        ...
        z = function (t) {
          if (u.currTemplate[L]) {
            ...
            e.length &&
              ...
              u.isIE8 && e.css("display", t ? "block" : "none"));
          }
        };
      ...
      c.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            ...
            (p += " mfp-gallery"),
              b(g + t, function () {
                r.navigateByImgClick &&
                  u.wrap.on("click" + t, ".mfp-img", function () {
              ...
              b("UpdateStatus" + t, function (t, e) {
                e.text &&
                  (e.text = R(e.text, u.currItem.index, u.items.length));
              }),
              ...
              b("BuildControls" + t, function () {
                if (1 < u.items.length && r.arrows && !u.arrowLeft) {
                  var t = r.arrowMarkup,
                    e = (u.arrowLeft = c(
                      t.replace(/%title%/gi, r.tPrev).replace(/%dir%/gi, "left")
                    ).addClass(a)),
                    i = (u.arrowRight = c(
                      t
          ...
          preloadNearbyImages: function () {
            var t,
              e = u.st.gallery.preload,
              i = Math.min(e[0], u.items.length),
              n = Math.min(e[1], u.items.length);
            for (t = 1; t <= (u.direction ? n : i); t++)
              u._preloadItem(u.index + t);
            for (t = 1; t <= (u.direction ? i : n); t++)
              u._preloadItem(u.index - t);
          },
          _preloadItem: function (t) {
            if (((t = F(t)), !u.items[t].preloaded)) {
              var e = u.items[t];
              e.parsed || (e = u.parseEl(t)),
                w("LazyLoad", e),
                "image" === e.type &&
    ...
    (function (i) {
      ...
      (t.prototype.options = {
            ...
            n = function (t) {
              ...
              !t.selectedOpt ||
                ...
                t.getAttribute("data-class") &&
                  (i += t.getAttribute("data-class")),
                t.getAttribute("data-link") &&
                  (n = "data-link=" + t.getAttribute("data-link")),
                "" !== i && (e = 'class="' + i + '" ');
              var o = "";
              return (
                [].forEach.call(t.attributes, function (t) {
                  var e = t.name;
                  e.indexOf("data-") +
                    ["data-option", "data-value"].indexOf(e) ==
                    -1 && (o += e + "='" + t.value + "' ");
                }),
                "<li " +
                  e +
          ...
          [].slice.call(this.el.children).forEach(function (t) {
            if (!t.disabled) {
              ...
              "option" === e
                ...
                : "optgroup" === e &&
                  ((i +=
                    '<li class="cs-optgroup"><span>' + t.label + "</span><ul>"),
                ...
                case 13:
                  t.preventDefault(),
                    i._isOpen() &&
                      void 0 !== i.preSelCurrent &&
                      -1 !== i.preSelCurrent &&
                      (i._changeOption(), i._toggleSelect());
                  break;
                case 27:
        ...
        (t.prototype._navigateOpts = function (t) {
          ...
          var e =
            void 0 !== this.preSelCurrent && -1 !== this.preSelCurrent
              ...
              : this.current;
          (("prev" === t && 0 < e) ||
            ("next" === t && e < this.selOptsCount - 1)) &&
            ((this.preSelCurrent = "next" === t ? e + 1 : e - 1),
            this._removeFocus(),
        ...
        (t.prototype._changeOption = function () {
          ...
          e && classie.remove(e, "cs-selected"),
            classie.add(t, "cs-selected"),
            t.getAttribute("data-link") &&
              (this.options.newTab
                ? i.open(t.getAttribute("data-link"), "_blank")
                : (i.location = t.getAttribute("data-link"))),
    ...
    (function (o, r) {
      ...
      r.extend(u, e.prototype),
        ...
        (c.create = function (t, e) {
          var i = h(c);
          return (
            (i.defaults = r.extend({}, c.defaults)),
            r.extend(i.defaults, e),
            (i.compatOptions = r.extend({}, c.compatOptions)),
            (i.namespace = t),
            (i.data = c.data),
            (i.Item = h(n)),
            r.htmlInit(i, t),
      ...
      return (
        ...
        (i._manageStamp = function (t) {
          ...
          for (
            ...
            this.colYs[l] = Math.max(s, this.colYs[l]);
        }),
    ...
    (function (a, s) {
      ...
      (c._create = function () {
        ...
        (c._filter = function (t) {
          ...
          e = e || "*";
          for (
            var i = [], n = [], o = [], r = this._getFilterTest(e), a = 0;
            a < t.length;
            a++
          ) {
            var s = t[a];
              ...
              (a.prototype = {
                ...
                (a.prototype.setValues = function (t, e) {
                  ...
                  if (
                    ((o.alpha = Math.max(
                      0,
                      Math.min(1, void 0 === s ? o.alpha : s)
                    )),
                    "alpha" === t)
                  )
                    return !1;
                  for (i = 0; i < t.length; i++)
                    (n = Math.max(0, Math.min(a[t][i], o[t][i]))),
                      (o[t][i] = Math.round(n));
          ...
          4: [
            function (t, e, i) {
              ...
              function s(t) {
                ...
                return [
                  100 *
                    ((1 - i - (e = Math.min(1 - i, 1 - n, 1 - o))) / (1 - e) ||
                      0),
                  100 * ((1 - n - e) / (1 - e) || 0),
                  100 * ((1 - o - e) / (1 - e) || 0),
                  100 * e,
              ...
              function m(t) {
                var e,
                  ...
                  a = t[2] / 100;
                return (
                  (i = -0.9689 * o + 1.8758 * r + 0.0415 * a),
                  (n = 0.0557 * o + -0.204 * r + 1.057 * a),
                  (e =
                    0.0031308 < (e = 3.2406 * o + -1.5372 * r + -0.4986 * a)
              ...
              function y(t) {
                ...
                return (
                  r <= 8
                    ? (o = ((i = (100 * r) / 903.3) / 100) * 7.787 + 16 / 116)
                    : ((i = 100 * Math.pow((r + 16) / 116, 3)),
                      (o = Math.pow(i / 100, 1 / 3))),
                  [
                    (e =
                      e / 95.047 <= 0.008856
                        ? (e = (95.047 * (a / 500 + o - 16 / 116)) / 7.787)
                        : 95.047 * Math.pow(a / 500 + o, 3)),
                    i,
                    (n =
                      n / 108.883 <= 0.008859
                        ? (n = (108.883 * (o - s / 200 - 16 / 116)) / 7.787)
              ...
              function x(t) {
                var e,
                  ...
                  o = t[2];
                return (
                  (e = (360 * Math.atan2(o, n)) / 2 / Math.PI) < 0 &&
                    (e += 360),
              ...
              e.exports = function (i) {
                (i.defaults.scatter = {
                  ...
                  scales: {
                    ...
                    yAxes: [
                      { type: "linear", position: "left", id: "y-axis-1" },
                    ],
                  },
                  tooltips: {
                    callbacks: {
                  ...
                  (i.controllers.bar = i.DatasetController.extend({
                    ...
                    getRuler: function (t) {
                      var e,
                        ...
                        a =
                          (e =
                            "category" === o.options.type
                              ? o.getPixelForTick(t + 1) - o.getPixelForTick(t)
                              : o.width / o.ticks.length) *
                          o.options.categoryPercentage,
                        s = (e - e * o.options.categoryPercentage) / 2,
                        l = a / r;
                      o.ticks.length !== i.chart.data.labels.length &&
                    ...
                    calculateBarX: function (t, e, i) {
                      ...
                      return (
                        (s -= n.chart.isCombo ? i.tickWidth / 2 : 0),
                        r.options.stacked
                          ? s + i.categoryWidth / 2 + i.categorySpacing
                          : s +
                            i.barWidth / 2 +
                            i.categorySpacing +
                            i.barWidth * a +
                    ...
                    calculateBarY: function (t, e) {
                      ...
                      if (o.options.stacked) {
                        ...
                        return r < 0
                          ? o.getPixelForValue(s + r)
                          : o.getPixelForValue(a + r);
                      }
                    ...
                    setHoverStyle: function (t) {
                      ...
                      (o.backgroundColor = n.hoverBackgroundColor
                        ...
                        : h.getValueAtIndexOrDefault(
                            ...
                            i,
                            h.getHoverColor(o.backgroundColor)
                          )),
                  ...
                  (i.controllers.horizontalBar = i.controllers.bar.extend({
                      ...
                      (t._model = {
                        ...
                        (t.draw = function () {
                          ...
                          var l = [
                            ...
                            d = ["bottom", "left", "top", "right"].indexOf(
                              i.borderSkipped,
                              0
                            );
                    ...
                    calculateBarY: function (t, e, i) {
                      var n = this,
                        ...
                        s = r.getPixelForValue(null, t, e, n.chart.isCombo);
                      return (
                        (s -= n.chart.isCombo ? i.tickHeight / 2 : 0),
                        r.options.stacked
                          ? s + i.categoryHeight / 2 + i.categorySpacing
                          : s +
                            i.barHeight / 2 +
                            i.categorySpacing +
                            i.barHeight * a +
                  ...
                  (p.controllers.bubble = p.DatasetController.extend({
                    ...
                    updateElement: function (t, e, i) {
                      ...
                      f.extend(t, {
                        ...
                        p.DatasetController.prototype.removeHoverStyle.call(
                          n,
                          t,
                          c
                        );
                    ...
                    removeHoverStyle: function (t) {
                      ...
                      var e = this.chart.data.datasets[t._datasetIndex].data[
                          t._index
                        ],
                        i = t.custom || {};
                  ...
                  legend: {
                          ...
                          ? d.labels.map(function (t, e) {
                              ...
                              return {
                                ...
                                fillStyle: r.backgroundColor
                                  ? r.backgroundColor
                                  : a(n.backgroundColor, e, s.backgroundColor),
                                strokeStyle: r.borderColor
                                  ? r.borderColor
                                  : a(n.borderColor, e, s.borderColor),
                                lineWidth: r.borderWidth
                                  ? r.borderWidth
                                  : a(n.borderWidth, e, s.borderWidth),
                    ...
                    onClick: function (t, e) {
                      var i,
                        ...
                        a = this.chart;
                      for (
                        i = 0, n = (a.data.datasets || []).length;
                        i < n;
                        ++i
                      )
                        (o = a.getDatasetMeta(i)).data[r] &&
                    ...
                    callbacks: {
                      ...
                      label: function (t, e) {
                        var i = e.labels[t.index],
                          n = ": " + e.datasets[t.datasetIndex].data[t.index];
                        return (
                          A.isArray(i) ? ((i = i.slice())[0] += n) : (i += n), i
                        );
                      },
                    },
                  },
                }),
                  (t.pie = A.clone(t.doughnut)),
                  A.extend(t.pie, { cutoutPercentage: 0 }),
                  (e.controllers.doughnut = e.controllers.pie = e.DatasetController.extend(
                    {
                      ...
                      update: function (i) {
                        ...
                        if (h < 2 * Math.PI) {
                          var p = o.rotation % (2 * Math.PI),
                            ...
                            b =
                              (p <= 0 && 0 <= f) ||
                              (p <= 2 * Math.PI && 2 * Math.PI <= f),
                            x =
                              (p <= 0.5 * Math.PI && 0.5 * Math.PI <= f) ||
                              (p <= 2.5 * Math.PI && 2.5 * Math.PI <= f),
                            w =
                              (p <= -Math.PI && -Math.PI <= f) ||
                              (p <= Math.PI && Math.PI <= f),
                            k =
                              (p <= 0.5 * -Math.PI && 0.5 * -Math.PI <= f) ||
                              (p <= 1.5 * Math.PI && 1.5 * Math.PI <= f),
                            S = u / 100,
                            C = w
                              ? -1
                              : Math.min(
                            ...
                            P = 0.5 * (M - T);
                          (l = Math.min(a / _, s / P)),
                            (d = { x: -0.5 * (I + C), y: -0.5 * (M + T) });
                        }
                        (t.borderWidth = n.getMaxBorderWidth(c.data)),
                          (t.outerRadius = Math.max(
                            (l - t.borderWidth) / 2,
                            0
                          )),
                          (t.innerRadius = Math.max(
                            u ? (t.outerRadius / 100) * u : 1,
                            0
                          )),
                          (t.radiusLength =
                      ...
                      getMaxBorderWidth: function (t) {
                        for (
                          var e, i, n = 0, o = this.index, r = t.length, a = 0;
                          a < r;
                          a++
                        )
                          n =
                            (n =
                              ...
                              (e = t[a]._model ? t[a]._model.borderWidth : 0)
                                ...
                                : n) <
                            (i = t[a]._chart
                              ? t[a]._chart.config.data.datasets[o]
                                  .hoverBorderWidth
                              : 0)
                              ? i
                              : n;
                  ...
                  (t.controllers.line = t.DatasetController.extend({
                    ...
                    update: function (t) {
                      ...
                      for (
                        h &&
                          ...
                          (a._scale = c),
                          (a._datasetIndex = o.index),
                          (a._children = s),
                          (a._model = {
                            spanGaps: u.spanGaps ? u.spanGaps : l.spanGaps,
                            tension: n.tension
                              ? n.tension
                              : g.getValueOrDefault(u.lineTension, d.tension),
                            backgroundColor: n.backgroundColor
                              ? n.backgroundColor
                              : u.backgroundColor || d.backgroundColor,
                            borderWidth: n.borderWidth
                              ? n.borderWidth
                              : u.borderWidth || d.borderWidth,
                            borderColor: n.borderColor
                              ? n.borderColor
                              : u.borderColor || d.borderColor,
                            borderCapStyle: n.borderCapStyle
                              ? n.borderCapStyle
                              : u.borderCapStyle || d.borderCapStyle,
                            borderDash: n.borderDash
                              ? n.borderDash
                              : u.borderDash || d.borderDash,
                            borderDashOffset: n.borderDashOffset
                              ? n.borderDashOffset
                              : u.borderDashOffset || d.borderDashOffset,
                            borderJoinStyle: n.borderJoinStyle
                              ? n.borderJoinStyle
                              : u.borderJoinStyle || d.borderJoinStyle,
                            fill: n.fill
                              ? n.fill
                              : void 0 !== u.fill
                              ? u.fill
                            ...
                            steppedLine: n.steppedLine
                              ? n.steppedLine
                              : g.getValueOrDefault(u.steppedLine, d.stepped),
                            cubicInterpolationMode: n.cubicInterpolationMode
                              ? n.cubicInterpolationMode
                              : g.getValueOrDefault(
                    ...
                    updateElement: function (t, e, i) {
                      ...
                      void 0 !== l.radius &&
                        ...
                        (o = i ? u.getBasePixel() : r.calculatePointY(c, e, d)),
                        (t._xScale = h),
                        (t._yScale = u),
                        (t._datasetIndex = d),
                        (t._index = e),
                        (t._model = {
                          ...
                          tension: a.dataset._model
                            ? a.dataset._model.tension
                            : 0,
                          steppedLine:
                            !!a.dataset._model && a.dataset._model.steppedLine,
                          hitRadius:
                            s.hitRadius ||
                            g.getValueAtIndexOrDefault(
                              l.pointHitRadius,
                    ...
                    calculatePointY: function (t, e, i) {
                      ...
                      if (l.options.stacked) {
                        for (n = 0; n < i; n++)
                          if (
                            ((o = a.data.datasets[n]),
                            "line" === (r = a.getDatasetMeta(n)).type &&
                              r.yAxisID === l.id &&
                    ...
                    updateBezierControlPoints: function () {
                      ...
                      if (
                        ...
                        for (e = 0, i = s.length; e < i; ++e)
                          (n = s[e]._model),
                            (o = g.splineCurve(
                              g.previousItem(s, e)._model,
                              n,
                              g.nextItem(s, e)._model,
                      ...
                      if (this.chart.options.elements.line.capBezierPoints)
                        for (e = 0, i = s.length; e < i; ++e)
                          ((n = s[e]._model).controlPointPreviousX = t(
                    ...
                    draw: function (t) {
                      ...
                      for (
                        p(this.getDataset(), this.chart.options) &&
                      ...
                      (o.radius =
                        ...
                        (o.backgroundColor =
                          ...
                          g.getValueAtIndexOrDefault(
                            ...
                            i,
                            g.getHoverColor(o.backgroundColor)
                          )),
                        (o.borderColor =
                          n.hoverBorderColor ||
                          g.getValueAtIndexOrDefault(
                  ...
                  legend: {
                          ...
                          ? l.labels.map(function (t, e) {
                              ...
                              return {
                                ...
                                fillStyle: o.backgroundColor
                                  ? o.backgroundColor
                                  : r(n.backgroundColor, e, a.backgroundColor),
                                strokeStyle: o.borderColor
                                  ? o.borderColor
                                  : r(n.borderColor, e, a.borderColor),
                                lineWidth: o.borderWidth
                                  ? o.borderWidth
                                  : r(n.borderWidth, e, a.borderWidth),
                                hidden: isNaN(n.data[e]) || i.data[e].hidden,
                                index: e,
                              };
                            })
                    ...
                    onClick: function (t, e) {
                      ...
                      for (
                        ...
                        (o = a.getDatasetMeta(i)).data[r].hidden = !o.data[r]
                          .hidden;
                      a.update();
                    },
                  },
                    ...
                    updateElement: function (t, e, i) {
                      for (
                        var n = this,
                          ...
                          c = o.data.labels,
                          u = n.calculateCircumference(r.data[e]),
                          h = l.xCenter,
                          p = l.yCenter,
                          f = 0,
                          g = n.getMeta(),
                        ...
                        isNaN(r.data[m]) || g.data[m].hidden || ++f;
                      var v = a.startAngle,
                        y = t.hidden
                          ? 0
                      ...
                      void 0 !== a.tension &&
                        ...
                        d.extend(t.dataset, {
                          ...
                          _model: {
                            tension: r.tension
                              ? r.tension
                              : d.getValueOrDefault(a.lineTension, s.tension),
                            backgroundColor: r.backgroundColor
                              ? r.backgroundColor
                              : a.backgroundColor || s.backgroundColor,
                            borderWidth: r.borderWidth
                              ? r.borderWidth
                              : a.borderWidth || s.borderWidth,
                            borderColor: r.borderColor
                              ? r.borderColor
                              : a.borderColor || s.borderColor,
                            fill: r.fill
                              ? r.fill
                              : void 0 !== a.fill
                              ? a.fill
                            ...
                            borderCapStyle: r.borderCapStyle
                              ? r.borderCapStyle
                              : a.borderCapStyle || s.borderCapStyle,
                            borderDash: r.borderDash
                              ? r.borderDash
                              : a.borderDash || s.borderDash,
                    ...
                    updateBezierControlPoints: function () {
                      ...
                      d.each(r.data, function (t, e) {
                        ...
                        (i.controlPointPreviousX = Math.max(
                          Math.min(n.previous.x, o.right),
                          o.left
                        )),
                          (i.controlPointPreviousY = Math.max(
                            Math.min(n.previous.y, o.bottom),
                            o.top
                          )),
                          (i.controlPointNextX = Math.max(
                            Math.min(n.next.x, o.right),
                            o.left
                          )),
                          (i.controlPointNextY = Math.max(
                            Math.min(n.next.y, o.bottom),
                            o.top
                          )),
                          t.pivot();
                      });
                      ...
                      (o.radius = i.hoverRadius
                        ...
                        (o.backgroundColor = i.hoverBackgroundColor
                          ...
                          : d.getValueAtIndexOrDefault(
                              e.pointHoverBackgroundColor,
                              n,
                              d.getHoverColor(o.backgroundColor)
                            )),
                  ...
                  (t.animationService = {
                    ...
                    addAnimation: function (t, e, i, n) {
                      ...
                      for (var r = 0; r < o.animations.length; ++r)
                        if (o.animations[r].chartInstance === t)
                          return void (o.animations[r].animationObject = e);
                      o.animations.push({
                        chartInstance: t,
                        animationObject: e,
                      }),
                    ...
                    requestAnimationFrame: function () {
                      var t = this;
                      null === t.request &&
                        (t.request = i.requestAnimFrame.call(
                          window,
                          function () {
            ...
            function (t, e, i) {
              ...
              e.exports = function (c) {
                ...
                (c.types = {}),
                  (c.instances = {}),
                  (c.controllers = {}),
                  (c.Controller = function (t, e, i) {
                    var n,
                      o,
                      r = this;
                    ((o = (n = (n = e) || {}).data = n.data || {}).datasets =
                      o.datasets || []),
                      (o.labels = o.labels || []),
                      (n.options = h.configMerge(
                        c.defaults.global,
                        c.defaults[n.type],
                        n.options || {}
                      ));
                    ...
                    return (
                      ...
                      a && s
                        ? (h.retinaScale(i),
                          r.options.responsive &&
                            (h.addResizeListener(s.parentNode, function () {
                              r.resize();
                            }),
                            r.resize(!0)),
                          r.initialize())
                  ...
                  h.extend(c.Controller.prototype, {
                    ...
                    resize: function (t) {
                      ...
                      if (i.width !== a || i.height !== s) {
                        ...
                        c.plugins.notify("resize", [e, l]),
                          e.options.onResize && e.options.onResize(e, l),
                          t ||
                            (e.stop(),
                          ...
                          function (t, e) {
                            ...
                            i.type || (i.type = t.type || n.config.type),
                              ...
                              i.controller
                                ...
                                : ((i.controller = new c.controllers[i.type](
                                    n,
                                    e
                                  )),
                                  r.push(i.controller));
                    ...
                    update: function (t, e) {
                      var i = this;
                      c.plugins.notify("beforeUpdate", [i]),
                      ...
                      h.each(
                        ...
                        c.plugins.notify("afterScaleUpdate", [i]),
                        h.each(n, function (t) {
                          t.reset();
                        }),
                        i.updateDatasets(),
                        c.plugins.notify("afterUpdate", [i]),
                        i._bufferedRender
                          ? (i._bufferedRequest = { lazy: e, duration: t })
                          : i.render(t, e);
                    },
                    ...
                    render: function (t, e) {
                      ...
                      if (
                        ...
                        (o.numSteps = (t || n.duration) / 16.66),
                          ...
                          c.animationService.addAnimation(i, o, t, e);
                      } else
                        i.draw(),
                          n &&
                            n.onComplete &&
                    ...
                    draw: function (i) {
                      var n = this,
                        t = i || 1;
                      n.clear(),
                        c.plugins.notify("beforeDraw", [n, t]),
                        h.each(
                          n.boxes,
                          function (t) {
                            t.draw(n.chartArea);
                        ...
                        c.plugins.notify("beforeDatasetsDraw", [n, t]),
                        h.each(
                          n.data.datasets,
                          function (t, e) {
                        ...
                        c.plugins.notify("afterDatasetsDraw", [n, t]),
                        n.tooltip.transition(t).draw(),
                        c.plugins.notify("afterDraw", [n, t]);
                    },
                    ...
                    destroy: function () {
                      var t,
                        ...
                        o = n.chart.canvas;
                      for (
                        n.stop(), e = 0, i = n.data.datasets.length;
                        e < i;
                        ++e
                      )
                        (t = n.getDatasetMeta(e)).controller &&
                          (t.controller.destroy(), (t.controller = null));
                      o &&
                        (h.unbindEvents(n, n.events),
                        h.removeResizeListener(o.parentNode),
                        h.clear(n.chart),
                        (function (i) {
                          if (i._chartjs) {
                        ...
                        (n.chart.canvas = null),
                        (n.chart.ctx = null)),
                        c.plugins.notify("destroy", [n]),
                        delete c.instances[n.id];
                    },
                    ...
                    updateHoverStyle: function (t, e, i) {
                      ...
                      for (o = 0, r = t.length; o < r; ++o)
                        (n = t[o]) &&
                          this.getDatasetMeta(n._datasetIndex).controller[a](n);
                    },
                    eventHandler: function (t) {
                      ...
                      return (
                        a
                          ? e.render(a.duration, a.lazy)
                          : r &&
                            !e.animating &&
                            (e.stop(), e.render(o.animationDuration, !0)),
                        (e._bufferedRender = !1),
                    ...
                    handleEvent: function (t) {
                      ...
                      return (
                        ...
                        "mouseout" === t.type
                          ? (i.active = [])
                          : (i.active = i.getElementsAtEventForMode(
                              t,
                              o.mode,
                              o
                            )),
                        o.onHover && o.onHover.call(i, i.active),
                        ("mouseup" === t.type || "click" === t.type) &&
                          n.onClick &&
                          n.onClick.call(i, t, i.active),
                        i.lastActive.length &&
                  ...
                  s.extend(t.DatasetController.prototype, {
                    ...
                    removeHoverStyle: function (t, e) {
                      ...
                      (a.backgroundColor = o.backgroundColor
                        ...
                        (a.borderColor = o.borderColor
                          ? o.borderColor
                          : r(i.borderColor, n, e.borderColor)),
                        (a.borderWidth = o.borderWidth
                          ? o.borderWidth
                    ...
                    setHoverStyle: function (t) {
                      ...
                      (a.backgroundColor = n.hoverBackgroundColor
                        ? n.hoverBackgroundColor
                        : o(e.hoverBackgroundColor, i, r(a.backgroundColor))),
                        (a.borderColor = n.hoverBorderColor
                          ? n.hoverBorderColor
                          : o(e.hoverBorderColor, i, r(a.borderColor))),
                        (a.borderWidth = n.hoverBorderWidth
                          ? n.hoverBorderWidth
                          : o(e.hoverBorderWidth, i, a.borderWidth));
                    },
                ...
                (t.elements = {}),
                  ...
                  a.extend(t.Element.prototype, {
                    ...
                    pivot: function () {
                      var t = this;
                      return (
                        t._view || (t._view = a.clone(t._model)),
                        (t._start = a.clone(t._view)),
                        t
                      );
                    },
                    ...
                    hasValue: function () {
                      return (
                        a.isNumber(this._model.x) && a.isNumber(this._model.y)
                      );
                    },
                  }),
            ...
            function (t, e, i) {
              ...
              e.exports = function (a) {
                ...
                function e(t, e, i) {
                  ...
                  return s || l
                    ? Math.min(s ? c(r, t, i) : d, l ? c(a, o, i) : d)
                    : "none";
                }
                var t,
                  f = (a.helpers = {});
                (f.each = function (t, e, i, n) {
                        ...
                        function (t) {
                          f.each(t, function (t, e) {
                            var i = o.hasOwnProperty(e),
                              n = i ? o[e] : {};
                            "scales" === e
                              ? (o[e] = f.scaleMerge(n, t))
                              : "scale" === e
                              ? (o[e] = f.configMerge(
                                  n,
                                  a.scaleService.getScaleDefaults(t.type),
                                  t
                                ))
                              : !i ||
                                "object" != typeof n ||
                    ...
                    return (
                      f.each(e, function (t, o) {
                        "xAxes" === o || "yAxes" === o
                          ? r.hasOwnProperty(o)
                            ? f.each(t, function (t, e) {
                                var i = f.getValueOrDefault(
                                    t.type,
                                    "xAxes" === o ? "category" : "linear"
                                  ),
                                  n = a.scaleService.getScaleDefaults(i);
                                e >= r[o].length || !r[o][e].type
                                  ? r[o].push(f.configMerge(n, t))
                                  : t.type && t.type !== r[o][e].type
                                  ? (r[o][e] = f.configMerge(r[o][e], n, t))
                                  : (r[o][e] = f.configMerge(r[o][e], t));
                              })
                            : ((r[o] = []),
                              f.each(t, function (t) {
                                var e = f.getValueOrDefault(
                                  t.type,
                                  "xAxes" === o ? "category" : "linear"
                                );
                                r[o].push(
                                  f.configMerge(
                                    a.scaleService.getScaleDefaults(e),
                                    t
                                  )
                                );
                              }))
                  ...
                  (f.where = function (t, e) {
                    if (f.isArray(t) && Array.prototype.filter)
                      return t.filter(e);
                    var i = [];
                    return (
                      f.each(t, function (t) {
                    ...
                    for (e = 0; e < u; ++e)
                      (n = c[e]).model.skip ||
                        ...
                        (o = e < u - 1 ? c[e + 1] : null) &&
                          !o.model.skip &&
                          (n.deltaK =
                            (o.model.y - n.model.y) / (o.model.x - n.model.x)),
                        !i || i.model.skip
                          ? (n.mK = n.deltaK)
                          : !o || o.model.skip
                          ? (n.mK = i.deltaK)
                    ...
                    for (e = 0; e < u; ++e)
                      (n = c[e]).model.skip ||
                        ...
                        i &&
                          ...
                          (n.model.controlPointPreviousY =
                            n.model.y - d * n.mK)),
                        o &&
                          !o.model.skip &&
                          ((d = (o.model.x - n.model.x) / 3),
                ...
                var i = (f.easingEffects = {
                  ...
                  easeInOutBounce: function (t) {
                    return t < 0.5
                      ? 0.5 * i.easeInBounce(2 * t)
                      : 0.5 * i.easeOutBounce(2 * t - 1) + 0.5;
                  },
                });
                (f.requestAnimFrame =
                  window.requestAnimationFrame ||
                  ...
                  (f.getRelativePosition = function (t, e) {
                    ...
                    return {
                      x: (i = Math.round(
                        (((i - a.left - l) / h) * r.width) /
                          e.currentDevicePixelRatio
                      )),
                      y: (n = Math.round(
                        (((n - a.top - d) / p) * r.height) /
                          e.currentDevicePixelRatio
                      )),
                    };
                  }),
                  ...
                  (f.measureText = function (t, e, i, n, o) {
                    var r = e[o];
                    return (
                      r || ((r = e[o] = t.measureText(o).width), i.push(o)),
                      n < r && (n = r),
                      n
                    );
                  }),
                    ...
                    return n
                      ? n(
                          t instanceof CanvasGradient
                            ? a.defaults.global.defaultColor
                            : t
                        )
                      : (console.error("Color.js not found!"), t);
                  }),
                  (f.addResizeListener = function (t, e) {
                    var i = document.createElement("iframe");
                    (i.className = "chartjs-hidden-iframe"),
                      (i.style.cssText =
                      ...
                      (i.tabIndex = -1);
                    var n = (t._chartjs = { resizer: i, ticking: !1 }),
                      o = function () {
                        n.ticking ||
                          ((n.ticking = !0),
                  ...
                  (f.getHoverColor = function (t) {
                    return t instanceof CanvasPattern
                      ? t
                      : f.color(t).saturate(0.5).darken(0.1).rgbString();
                  });
              };
            },
            { 3: 3 },
                ...
                function l(t, e) {
                  ...
                  for (n = 0, r = t.data.datasets.length; n < r; ++n)
                    if (t.isDatasetVisible(n))
                      for (
                        o = 0, a = (i = t.getDatasetMeta(n)).data.length;
                        o < a;
                        ++o
                      ) {
                        var s = i.data[o];
                ...
                t.Interaction = {
                  modes: {
                    ...
                    dataset: function (t, e, i) {
                      ...
                      return (
                        0 < o.length &&
                          (o = t.getDatasetMeta(o[0]._datasetIndex).data),
                        o
                      );
                    },
                    "x-axis": function (t, e) {
                    ...
                    nearest: function (t, e, i) {
                      var n = s(
                        t,
                        d.getRelativePosition(e, t.chart),
                        i.intersect
                      );
                      return (
                        1 < n.length &&
                          n.sort(function (t, e) {
                            ...
                            return (
                              0 === i &&
                                (i = t._datasetIndex - e._datasetIndex),
                              i
                            );
                          }),
                        n.slice(0, 1)
          ...
          28: [
            function (t, e, i) {
              ...
              e.exports = function () {
                var i = function (t, e) {
                  return (
                    (this.controller = new i.Controller(t, e, this)),
                    this.controller
                  );
                };
                return (
              ...
              e.exports = function (t) {
                ...
                t.layoutService = {
                  ...
                  update: function (e, i, t) {
                    function n(e) {
                      var t = O.findNextWhere(S, function (t) {
                        return t.box === e;
                      });
                      if (t)
                        if (e.isHorizontal()) {
                          var i = { left: C, right: T, top: 0, bottom: 0 };
                          e.update(e.options.fullWidth ? m : w, v / 2, i);
                        } else e.update(t.minSize.width, k);
                    }
                    function o(t) {
                      t.isHorizontal()
                        ? ((t.left = t.options.fullWidth ? s : C),
                          (t.right = t.options.fullWidth ? i - l : C + w),
                          (t.top = D),
                          (t.bottom = D + t.height),
                          (D = t.bottom))
                        : ((t.left = A),
                    ...
                    if (e) {
                      ...
                      isNaN(a)
                        ? ((s = a.left || 0),
                          ...
                          (c = a.bottom || 0))
                        : (c = d = l = s = a);
                      var u = O.where(e.boxes, function (t) {
                          return "left" === t.options.position;
                        }),
                        h = O.where(e.boxes, function (t) {
                          return "right" === t.options.position;
                        }),
                        p = O.where(e.boxes, function (t) {
                          return "top" === t.options.position;
                        }),
                        f = O.where(e.boxes, function (t) {
                          return "bottom" === t.options.position;
                        }),
                        g = O.where(e.boxes, function (t) {
                      ...
                      var m = i - s - l,
                        ...
                        k = v,
                        S = [];
                      O.each(u.concat(h, p, f), function (t) {
                        var e,
                          i = t.isHorizontal();
                        i
                          ? ((e = t.update(t.options.fullWidth ? m : w, x)),
                            (k -= e.height))
                          : ((e = t.update(b, y)), (w -= e.width)),
                      ...
                      O.each(u.concat(h), n),
                        ...
                        O.each(u.concat(h), function (e) {
                          var t = O.findNextWhere(S, function (t) {
                              return t.box === e;
                            }),
                            i = { left: 0, right: 0, top: I, bottom: M };
              ...
              e.exports = function (T) {
                ...
                (T.defaults.global.legend = {
                  ...
                  onClick: function (t, e) {
                    ...
                    (o.hidden =
                      null === o.hidden ? !n.data.datasets[i].hidden : null),
                      n.update();
                  },
                  onHover: null,
                  labels: {
                    ...
                    generateLabels: function (i) {
                      var t = i.data;
                      return M.isArray(t.datasets)
                        ? t.datasets.map(function (t, e) {
                            return {
                              text: t.label,
                              fillStyle: M.isArray(t.backgroundColor)
                                ? t.backgroundColor[0]
                                : t.backgroundColor,
                  ...
                  (T.Legend = T.Element.extend({
                    ...
                    fit: function () {
                      ...
                      if (
                        ...
                        if (((r.font = c), p)) {
                          ...
                          (r.textAlign = "left"),
                            (r.textBaseline = "top"),
                            M.each(n.legendItems, function (t, e) {
                              var i =
                                I(o, s) + s / 2 + r.measureText(t.text).width;
                              f[f.length - 1] + i + o.padding >= n.width &&
                                ((g += s + o.padding), (f[f.length] = n.left)),
                                (u[e] = {
                                  left: 0,
                                  top: 0,
                                  width: i,
                          ...
                          M.each(n.legendItems, function (t, e) {
                            var i =
                              I(o, s) + s / 2 + r.measureText(t.text).width;
                            x + w > h.height &&
                              ((y += b + o.padding), v.push(b), (x = b = 0)),
                              (b = Math.max(b, i)),
                              (x += w),
                              (u[e] = { left: 0, top: 0, width: i, height: s });
                          }),
                            (y += b),
                            v.push(b),
                            (h.width += y);
                    ...
                    draw: function () {
                      ...
                      if (u.display) {
                        ...
                        var C = x + h.padding;
                        M.each(c.legendItems, function (t, e) {
                          var i,
                            n,
                            o,
                            r,
                            a = y.measureText(t.text).width,
                            s = w + x / 2 + a,
                            l = v.x,
                            d = v.y;
                          S
                            ? g <= l + s &&
                              ((d = v.y += C),
                              v.line++,
                              (l = v.x = c.left + (g - m[v.line]) / 2))
                            : d + C > c.bottom &&
                              ((l = v.x =
                                l + c.columnWidths[v.line] + h.padding),
                              (d = v.y = c.top),
                              v.line++),
                            (function (t, e, i) {
                              if (!(isNaN(w) || w <= 0)) {
                                y.save(),
                                  ...
                                  (y.lineCap = b(i.lineCap, f.borderCapStyle)),
                                  (y.lineDashOffset = b(
                                    i.lineDashOffset,
                                    f.borderDashOffset
                                  )),
                                  ...
                                  (y.lineWidth = b(i.lineWidth, f.borderWidth)),
                                  (y.strokeStyle = b(
                                    i.strokeStyle,
                                    p.defaultColor
                                  ));
                                ...
                                if (
                                  (y.setLineDash &&
                                    y.setLineDash(b(i.lineDash, f.borderDash)),
                    ...
                    handleEvent: function (t) {
                      ...
                      var r = M.getRelativePosition(t, e.chart.chart),
                        a = r.x,
                        s = r.y;
                      if (
                        a >= e.left &&
              ...
              e.exports = function (j) {
                ...
                (j.defaults.scale = {
                  ...
                  ticks: {
                    ...
                    autoSkipPadding: 0,
                    labelOffset: 0,
                    callback: j.Ticks.formatters.values,
                  },
                }),
                  (j.Scale = j.Element.extend({
                    ...
                    beforeTickToLabelConversion: function () {
                      $.callCallback(this.options.beforeTickToLabelConversion, [
                        this,
                      ]);
                    },
                    ...
                    afterTickToLabelConversion: function () {
                      $.callCallback(this.options.afterTickToLabelConversion, [
                        this,
                      ]);
                    },
                    beforeCalculateTickRotation: function () {
                      $.callCallback(this.options.beforeCalculateTickRotation, [
                        this,
                      ]);
                    },
                      ...
                      if (
                        ...
                        for (
                          var u,
                            ...
                            f = p,
                            g = t.getPixelForTick(1) - t.getPixelForTick(0) - 6;
                          g < f && t.labelRotation < n.maxRotation;

                        ) {
                          if (
                            ((u = Math.cos($.toRadians(t.labelRotation))),
                            (h = Math.sin($.toRadians(t.labelRotation))),
                            (l = u * d) + o / 2 > t.yLabelWidth &&
                              (t.paddingLeft = l + o / 2),
                            (t.paddingRight = o / 2),
                            h * p > t.maxHeight)
                          ) {
                    ...
                    afterCalculateTickRotation: function () {
                      $.callCallback(this.options.afterCalculateTickRotation, [
                        this,
                      ]);
                    },
                    beforeFit: function () {
                    ...
                    fit: function () {
                      ...
                      if (
                        ...
                        r.display &&
                          s &&
                          (l ? (e.height += 1.5 * p) : (e.width += 1.5 * p)),
                        o.display && s)
                      ) {
                        t.longestTextCache || (t.longestTextCache = {});
                        var g = $.longestText(
                        ...
                        if (l) {
                          ...
                          var y =
                            Math.sin($.toRadians(t.labelRotation)) *
                              t.longestLabelWidth +
                            d * m +
                            v * m;
                          (e.height = Math.min(t.maxHeight, e.height + y)),
                            (t.ctx.font = h);
                          var b = t.ctx.measureText(t.ticks[0]).width,
                            x = t.ctx.measureText(t.ticks[t.ticks.length - 1])
                              .width,
                            w = Math.cos($.toRadians(t.labelRotation)),
                            k = Math.sin($.toRadians(t.labelRotation));
                          (t.paddingLeft =
                            0 !== t.labelRotation ? w * b + 3 : b / 2 + 3),
                            (t.paddingRight =
                              0 !== t.labelRotation
                                ? k * (d / 2) + 3
                                : x / 2 + 3);
                    ...
                    getPixelForTick: function (t, e) {
                      ...
                      if (i.isHorizontal()) {
                        ...
                        return (
                          ...
                          i.left +
                            Math.round(o) +
                            (i.isFullWidth() ? i.margins.left : 0)
                        );
                      }
                    ...
                    draw: function (b) {
                      ...
                      if (w.display) {
                        ...
                        var r = $.getValueOrDefault(
                          ...
                          d = $.fontString(a, s, l),
                          M = C.tickMarkLength,
                          _ = $.getValueOrDefault(C.borderDash, e.borderDash),
                          P = $.getValueOrDefault(
                            C.borderDashOffset,
                            e.borderDashOffset
                          ),
                        ...
                        var O = "right" === w.position ? x.left : x.right - M,
                          E = "right" === w.position ? x.left + M : x.right,
                          L = "bottom" === w.position ? x.top : x.bottom - M,
                          z = "bottom" === w.position ? x.top + M : x.bottom;
                        if (
                          ($.each(x.ticks, function (t, e) {
                            if (null != t) {
                              ...
                              if (
                                ...
                                (void 0 !== x.zeroLineIndex
                                  ...
                                  ? ((n = C.zeroLineWidth),
                                    (o = C.zeroLineColor))
                                  : ((n = $.getValueAtIndexOrDefault(
                                      C.lineWidth,
                                      e
                                    )),
                                    (o = $.getValueAtIndexOrDefault(
                                      C.color,
                                      e
                                    )));
                                var r,
                                ...
                                if (I) {
                                  T ||
                                    (m =
                                      "top" === w.position ? "bottom" : "top"),
                                    (g = T ? "right" : "center");
                                  var v =
                                    x.getPixelForTick(e) + $.aliasPixel(n);
                                  (p =
                                    x.getPixelForTick(e, C.offsetGridLines) +
                                    S.labelOffset),
                                    (f = T
                                      ? x.top + 12
                                      : "top" === w.position
                                  ...
                                  "left" === w.position
                                    ? S.mirror
                                      ...
                                      : ((p = x.right - S.padding),
                                        (g = "right"))
                                    : S.mirror
                                    ? ((p = x.left - S.padding), (g = "right"))
                                    : ((p = x.left + S.padding), (g = "left"));
                          ...
                          $.each(D, function (t) {
                            if (
                              (C.display &&
                                ...
                                o.beginPath(),
                                C.drawTicks &&
                                  (o.moveTo(t.tx1, t.ty1),
                                  o.lineTo(t.tx2, t.ty2)),
                                C.drawOnChartArea &&
                              ...
                              if ($.isArray(e))
                                for (
                                  var i = 0, n = -(e.length - 1) * a * 0.75;
                                  i < e.length;
                                  ++i
                                )
                                  o.fillText("" + e[i], 0, n), (n += 1.5 * a);
                        ...
                        if (C.drawBorder) {
                          (o.lineWidth = $.getValueAtIndexOrDefault(
                            C.lineWidth,
                            0
                          )),
                          ...
                          var W = x.left,
                            ...
                            H = x.top,
                            V = x.bottom,
                            N = $.aliasPixel(o.lineWidth);
                          I
                            ? ((H = V =
                                "top" === w.position ? x.bottom : x.top),
                              (H += N),
                              (V += N))
                            : ((W = B =
                                "left" === w.position ? x.right : x.left),
                              (W += N),
                              (B += N)),
                            o.beginPath(),
                            o.moveTo(W, H),
                  ...
                  generators: {
                    linear: function (t, e) {
                      ...
                      t.min &&
                        t.max &&
                        t.stepSize &&
                        (t.max - t.min) % t.stepSize == 0 &&
                        ((r = t.min), (a = t.max));
                      var s = (a - r) / i;
                      (s = d.almostEquals(s, Math.round(s), i / 1e3)
                        ? Math.round(s)
                        : Math.ceil(s)),
                    ...
                    logarithmic: function (t, e) {
                      for (
                        var i = [],
                          ...
                          o = n(
                            t.min,
                            Math.pow(10, Math.floor(d.log10(e.min)))
                          );
                        o < e.max;
                        ...
                        i.push(o),
                          0 === o
                            ? ((r = Math.floor(d.log10(e.minNotZero))),
                              (a = Math.round(e.minNotZero / Math.pow(10, r))))
                            : ((r = Math.floor(d.log10(o))),
                              (a = Math.floor(o / Math.pow(10, r)) + 1)),
                          10 === a && ((a = 1), ++r),
                          (o = a * Math.pow(10, r));
                      }
                      var s = n(t.max, o);
                  ...
                  fit: function () {
                    ...
                    this.isHorizontal()
                      ? ((r.width = this.maxWidth),
                        (r.height = n ? o + 2 * e.padding : 0))
                      : ((r.width = n ? o + 2 * e.padding : 0),
                  ...
                  draw: function () {
                    ...
                    if (i.display) {
                      var o,
                        r,
                        a,
                        s = e(i.fontSize, n.defaultFontSize),
                      ...
                      (t.fillStyle = e(i.fontColor, n.defaultFontColor)),
                        ...
                        this.isHorizontal()
                          ? ((o = p + (g - p) / 2),
                            ...
                            (a = g - p))
                          : ((o =
                              "left" === i.position ? p + s / 2 : g - s / 2),
                            (r = h + (f - h) / 2),
                            (a = f - h),
                            (u =
                              Math.PI * ("left" === i.position ? -0.5 : 0.5))),
                        t.save(),
                        t.translate(o, r),
                        t.rotate(u),
                        (t.textAlign = "center"),
                        (t.textBaseline = "middle"),
                        t.fillText(i.text, 0, 0, a),
                        t.restore();
                    }
                  },
                })),
                ...
                (E.defaults.global.tooltips = {
                  ...
                  (E.Tooltip = E.Element.extend({
                    ...
                    getBody: function (t, i) {
                      ...
                      return (
                        z.each(t, function (t) {
                          ...
                          a(e.before, o.beforeLabel.call(n, t, i)),
                            a(e.lines, o.label.call(n, t, i)),
                            a(e.after, o.afterLabel.call(n, t, i)),
                            r.push(e);
                        }),
                        r
                      );
                    ...
                    update: function (t) {
                      var e,
                        ...
                        T = x._data,
                        I = x._chartInstance,
                        M = { xAlign: k.xAlign, yAlign: k.yAlign },
                        _ = { x: k.x, y: k.y },
                        P = { width: k.width, height: k.height },
                        A = { x: k.caretX, y: k.caretY };
                      if (C.length) {
                        S.opacity = 1;
                        var D = [];
                        A = E.Tooltip.positioners[w.position](
                          C,
                          x._eventPosition
                        );
                        var O = [];
                        ...
                        w.filter &&
                          ...
                          z.each(O, function (t) {
                            D.push(w.callbacks.labelColor.call(x, t, I));
                          }),
                          (S.title = x.getTitle(O, T)),
                          (S.beforeBody = x.getBeforeBody(O, T)),
                          (S.body = x.getBody(O, T)),
                          (S.afterBody = x.getAfterBody(O, T)),
                          (S.footer = x.getFooter(O, T)),
                          (S.x = Math.round(A.x)),
                          (S.y = Math.round(A.y)),
                          (S.caretPadding = z.getValueOrDefault(A.padding, 2)),
                          (S.labelColors = D),
                          (S.dataPoints = O),
                          (M = (function (t, e) {
                            var i = t._model,
                            ...
                            i.y < e.height
                              ? (a = "top")
                              : i.y > n.height - e.height && (a = "bottom");
                            var s,
                              l,
                              d,
                              c,
                            ...
                            "center" === a
                              ...
                              s(i.x)
                                ? ((r = "left"),
                                  d(i.x) && ((r = "center"), (a = u(i.y))))
                                : l(i.x) &&
                                  ((r = "right"),
                                  c(i.x) && ((r = "center"), (a = u(i.y))));
                            var f = t._options;
                            return {
                            ...
                            (P = (function (t, e) {
                              ...
                              return (
                                ...
                                z.each(e.beforeBody.concat(e.afterBody), p),
                          ...
                          "right" === u
                            ? (a -= o.width)
                            : "center" === u && (a -= o.width / 2),
                          "top" === h
                            ? (s += p)
                            : (s -=
                                "bottom" === h ? o.height + p : o.height / 2),
                          "center" === h
                            ? "left" === u
                              ? (a += p)
                              : "right" === u && (a -= p)
                      ...
                      "center" === f
                        ...
                        : ("left" === p
                          ...
                          "top" === f
                            ...
                            : (s = (a = m + y) + u),
                          (l = a)),
                        (c.fillStyle = b(d.backgroundColor, i)),
                        c.beginPath(),
                        c.moveTo(n, a),
                        c.lineTo(o, s),
                        c.lineTo(r, l),
                    ...
                    drawTitle: function (t, e, i, n) {
                      ...
                      if (o.length) {
                        ...
                        var r,
                          ...
                          l = e.titleSpacing;
                        for (
                          i.fillStyle = b(e.titleFontColor, n),
                            i.font = z.fontString(
                              s,
                              e._titleFontStyle,
                              e._titleFontFamily
                    ...
                    drawBackground: function (t, e, i, n, o) {
                      (i.fillStyle = b(e.backgroundColor, o)),
                    ...
                    draw: function () {
                      ...
                      if (0 !== e.opacity) {
                        ...
                        this._options.enabled &&
                          (this.drawBackground(n, e, t, i, o),
                          this.drawCaret(n, i, o),
                          (n.x += e.xPadding),
                          (n.y += e.yPadding),
                    ...
                    handleEvent: function (t) {
                      ...
                      if (
                        ...
                        (n = !z.arrayEquals(e._active, e._lastActive)),
                        ...
                        e.update(!0),
                          e.pivot(),
                          (n |= o.x !== e._model.x || o.y !== e._model.y);
                      }
                      return n;
                    },
                  })),
                  (E.Tooltip.positioners = {
                    average: function (t) {
                      ...
                      return { x: Math.round(n / r), y: Math.round(o / r) };
                    },
                ...
                (e.elements.arc = {
                  ...
                  (t.elements.Arc = t.Element.extend({
                    ...
                    inRange: function (t, e) {
                      ...
                      if (i) {
                        for (
                          var n = c.getAngleFromPoint(i, { x: t, y: e }),
                            o = n.angle,
                            r = n.distance,
                            a = i.startAngle,
                            s = i.endAngle;
                    ...
                    getArea: function () {
                      ...
                      return (
                        ...
                        (Math.pow(t.outerRadius, 2) -
                          Math.pow(t.innerRadius, 2))
                      );
                    },
                    tooltipPosition: function () {
                      var t = this._view,
                  ...
                  (t.elements.Line = t.Element.extend({
                    draw: function () {
                      ...
                      if ((o && c.length && c.push(c[0]), c.length && e.fill)) {
                        for (r.beginPath(), a = 0; a < c.length; ++a)
                          (s = c[a]),
                            (l = p.previousItem(c, a)),
                            (d = s._view),
                            0 === a
                              ? (o ? r.moveTo(n.x, n.y) : r.moveTo(d.x, n),
                                d.skip || ((u = a), r.lineTo(d.x, d.y)))
                              : ((l = -1 === u ? l : c[u]),
                                d.skip
                                  ? i ||
                                    u !== a - 1 ||
                                  ...
                                  : (u !== a - 1
                                      ...
                                      : t(l, s),
                                    (u = a)));
                        o || -1 === u || r.lineTo(c[u]._view.x, n),
                          (r.fillStyle = e.backgroundColor || f.defaultColor),
                          r.closePath(),
                          r.fill();
                      }
                      var h = f.elements.line;
                      for (
                        r.lineCap = e.borderCapStyle || h.borderCapStyle,
                          r.setLineDash &&
                            r.setLineDash(e.borderDash || h.borderDash),
                          r.lineDashOffset =
                            e.borderDashOffset || h.borderDashOffset,
                          r.lineJoin = e.borderJoinStyle || h.borderJoinStyle,
                          r.lineWidth = e.borderWidth || h.borderWidth,
                          r.strokeStyle = e.borderColor || f.defaultColor,
                          r.beginPath(),
                          u = -1,
                          a = 0;
                        a < c.length;
                  ...
                  (a.elements.Point = a.Element.extend({
                    ...
                    inYRange: function (t) {
                      ...
                      return (
                        !!e &&
                        Math.pow(t - e.y, 2) <
                          Math.pow(e.radius + e.hitRadius, 2)
                      );
                    },
                    getCenterPoint: function () {
                      var t = this._view;
                    ...
                    draw: function () {
                      ...
                      t.skip ||
                        ...
                        a.canvasHelpers.drawPoint(e, i, n, o, r));
                    },
                  }));
              };
            },
                ...
                var n = t.helpers,
                  e = t.Scale.extend({
                    ...
                    getPixelForValue: function (t, e, i, n) {
                      var o = this,
                        r = Math.max(
                          o.maxIndex +
                            1 -
                            o.minIndex -
                            (o.options.gridLines.offsetGridLines ? 0 : 1),
                          1
                        );
                      if (void 0 !== t && isNaN(e)) {
                      ...
                      if (o.isHorizontal()) {
                        var s =
                            (o.width - (o.paddingLeft + o.paddingRight)) / r,
                          l = s * (e - o.minIndex) + o.paddingLeft;
                        return (
                          ((o.options.gridLines.offsetGridLines && n) ||
                            (o.maxIndex === o.minIndex && n)) &&
                            (l += s / 2),
                          o.left + Math.round(l)
                        );
                      }
                      ...
                      return (
                        o.options.gridLines.offsetGridLines &&
                          n &&
                          (c += d / 2),
                        o.top + Math.round(c)
                      );
                    ...
                    getValueForPixel: function (t) {
                      ...
                      return (
                        (t -= n ? e.left : e.top),
                        e.options.gridLines.offsetGridLines && (t -= o / 2),
            ...
            function (t, e, i) {
              ...
              e.exports = function (n) {
                var c = n.helpers,
                  t = {
                    position: "left",
                    ticks: { callback: n.Ticks.formatters.linear },
                  },
                  e = n.LinearScaleBase.extend({
                    ...
                    getPixelForValue: function (t) {
                      ...
                      return n.isHorizontal()
                        ? ((i = n.width - (o + n.paddingRight)),
                          (e = n.left + (i / l) * (s - a)),
                          Math.round(e + o))
                        : ((i = n.height - (n.paddingTop + r)),
                          (e = n.bottom - r - (i / l) * (s - a)),
                          Math.round(e));
                    },
                    getValueForPixel: function (t) {
                      var e = this,
                ...
                r.LinearScaleBase = r.Scale.extend({
                  ...
                  convertTicksToLabels: function () {
                    (this.ticksAsNumbers = this.ticks.slice()),
                      ...
                      r.Scale.prototype.convertTicksToLabels.call(this);
                  },
                });
              };
            },
            ...
            function (t, e, i) {
              ...
              e.exports = function (o) {
                var u = o.helpers,
                  t = {
                    position: "left",
                    ticks: { callback: o.Ticks.formatters.logarithmic },
                  },
                  e = o.Scale.extend({
                    determineDataLimits: function () {
                      function i(t) {
                          ...
                          s.isDatasetVisible(e) &&
                            ...
                            u.each(t.data, function (t, e) {
                              ...
                              isNaN(n) ||
                                o.data[e].hidden ||
                                ((i[e] = i[e] || 0),
                                a.relativePoints ? (i[e] = 100) : (i[e] += n));
                            }));
                        }),
                          u.each(l, function (t) {
                            var e = u.min(t),
                            ...
                            u.each(t.data, function (t, e) {
                              ...
                              isNaN(i) ||
                                ...
                                null === r.max
                                  ...
                                  : i > r.max && (r.max = i),
                                0 !== i &&
                                  (null === r.minNotZero || i < r.minNotZero) &&
                                  (r.minNotZero = i));
                            });
                        });
                      (r.min = n(t.min, r.min)),
                    ...
                    convertTicksToLabels: function () {
                      (this.tickValues = this.ticks.slice()),
                        o.Scale.prototype.convertTicksToLabels.call(this);
                    },
                    getLabelForIndex: function (t, e) {
                      return +this.getRightValue(
                        this.chart.data.datasets[e].data[t]
                    ...
                    getPixelForValue: function (t) {
                      ...
                      return (
                        o.isHorizontal()
                          ? ((n = u.log10(o.end) - u.log10(r)),
                            0 === a
                              ? (i = o.left + d)
                              : ((e = o.width - (d + o.paddingRight)),
                                (i =
                                  o.left + (e / n) * (u.log10(a) - u.log10(r))),
                                (i += d)))
                          : ((e = o.height - (s + l)),
                            0 !== r || c.reverse
                              ? 0 === o.end && c.reverse
                                ? ((n =
                                    u.log10(o.start) - u.log10(o.minNotZero)),
                                  (i =
                                    a === o.end
                                      ? o.top + s
                                      : a === o.minNotZero
                                      ...
                                      : o.top +
                                        ...
                                        0.02 * e +
                                        ((0.98 * e) / n) *
                                          (u.log10(a) - u.log10(o.minNotZero))))
                                : ((n = u.log10(o.end) - u.log10(r)),
                                  (e = o.height - (s + l)),
                                  (i =
                                    o.bottom -
                                    l -
                                    (e / n) * (u.log10(a) - u.log10(r))))
                              : ((n = u.log10(o.end) - u.log10(o.minNotZero)),
                                (i =
                                  a === r
                                    ? o.bottom - l
                                    : a === o.minNotZero
                  ...
                  i = t.LinearScaleBase.extend({
                    ...
                    fit: function () {
                      var t,
                        ...
                        f = S.getValueOrDefault(
                          h.fontStyle,
                          C.defaultFontStyle
                        ),
                        g = S.getValueOrDefault(
                          h.fontFamily,
                          C.defaultFontFamily
                        ),
                      ...
                      (l = b),
                        (d = Math.ceil(y - this.width)),
                        (r = this.getIndexAngle(o)),
                        (s = this.getIndexAngle(a)),
                        (c = d / Math.sin(r + Math.PI / 2)),
                        (u = l / Math.sin(s + Math.PI / 2)),
                        (c = S.isNumber(c) ? c : 0),
                        (u = S.isNumber(u) ? u : 0),
                        (this.drawingArea = Math.round(v - (u + c) / 2)),
                        ...
                        if (
                          (S.each(l.ticks, function (t, e) {
                            if (0 < e || d.reverse) {
                              ...
                              if (c.display && 0 !== e)
                                if (
                                  ((p.strokeStyle = S.getValueAtIndexOrDefault(
                                    c.color,
                                    e - 1
                                  )),
                                  (p.lineWidth = S.getValueAtIndexOrDefault(
                                    c.lineWidth,
                                    e - 1
                                  )),
                                  d.lineArc)
                              ...
                              if (u.display) {
                                ...
                                if (((p.font = g), u.showLabelBackdrop)) {
                                  ...
                                  (p.fillStyle = u.backdropColor),
                                    p.fillRect(
                                      l.xCenter - s / 2 - u.backdropPaddingX,
                                      n - f / 2 - u.backdropPaddingY,
                                      s + 2 * u.backdropPaddingX,
                                      f + 2 * u.backdropPaddingY
                                    );
                                }
                                (p.textAlign = "center"),
                                  (p.textBaseline = "middle"),
                                  (p.fillStyle = a),
                                  p.fillText(t, l.xCenter, n);
                              }
                            }
                          }),
                          !d.lineArc)
                          ...
                          (p.lineWidth = t.lineWidth),
                            (p.strokeStyle = t.color);
                          for (
                            var o = l.getDistanceFromCenterForValue(
                                d.reverse ? l.min : l.max
                              ),
                              r = h(e.fontSize, C.defaultFontSize),
                              a = h(e.fontStyle, C.defaultFontStyle),
                              s = h(e.fontFamily, C.defaultFontFamily),
                              m = S.fontString(r, a, s),
                              v = l.getValueCount() - 1;
                            0 <= v;
                            v--
                          ) {
                  ...
                  var x = b.helpers,
                    ...
                    t = b.Scale.extend({
                      ...
                      getLabelDiff: function (t, e) {
                        return null === t || null === e
                          ? null
                          : (void 0 === this.labelDiffs &&
                              this.buildLabelDiffs(),
                            void 0 !== this.labelDiffs[t]
                              ? this.labelDiffs[t][e]
                              : null);
                      },
                        ...
                        o.chart.data.labels && 0 < o.chart.data.labels.length
                          ? (x.each(
                              ...
                              function (t) {
                                var e = o.parseTime(t);
                                e.isValid() &&
                                  (o.options.time.round &&
                                    e.startOf(o.options.time.round),
                                  r.push(e));
                              },
                              o
                            ),
                          ...
                          o.options.time.min &&
                            (o.firstTick = o.parseTime(o.options.time.min)),
                          o.options.time.max &&
                            (o.lastTick = o.parseTime(o.options.time.max)),
                        ...
                        n.chart.data.labels &&
                          ...
                          x.each(
                            ...
                            function (t) {
                              var e = n.parseTime(t);
                              e.isValid() &&
                                (n.options.time.round &&
                                  e.startOf(n.options.time.round),
                                o.push(e.diff(n.firstTick, n.tickUnit, !0)));
                            },
                            n
                          ),
                          x.each(
                                    ...
                                    function (t) {
                                      ...
                                      e.isValid() &&
                                        (n.options.time.round &&
                                          e.startOf(n.options.time.round),
                                        i.push(
                                          e.diff(n.firstTick, n.tickUnit, !0)
                                        ));
                                    },
                                    n
                                  )
                      ...
                      buildTicks: function () {
                        ...
                        var e,
                          ...
                          n = x.getValueOrDefault(
                            t.options.ticks.fontStyle,
                            b.defaults.global.defaultFontStyle
                          ),
                          o = x.getValueOrDefault(
                            t.options.ticks.fontFamily,
                        ...
                        if (
                          ...
                          (t.ticks = []),
                          (t.unitScale = 1),
                          (t.scaleSizeInUnits = 0),
                          t.options.time.unit)
                        )
                          (t.tickUnit = t.options.time.unit || "day"),
                            (t.displayFormat =
                              t.options.time.displayFormats[t.tickUnit]),
                            (t.scaleSizeInUnits = t.lastTick.diff(
                              t.firstTick,
                              t.tickUnit,
                              !0
                            )),
                            (t.unitScale = x.getValueOrDefault(
                              t.options.time.unitStepSize,
                              1
                            ));
                        else {
                          var a = t.isHorizontal()
                            ...
                            d =
                              ...
                              (l =
                                l *
                                  Math.cos(
                                    x.toRadians(t.options.ticks.maxRotation)
                                  ) +
                                i *
                                  Math.sin(
                                    x.toRadians(t.options.ticks.maxRotation)
                          ...
                          for (
                            ...
                            if (
                              ((t.unitScale = 1),
                              x.isArray(u.steps) &&
                                Math.ceil(t.scaleSizeInUnits / d) <
                                  x.max(u.steps))
                            ) {
                            ...
                            if (
                              !1 === u.maxStep ||
                              Math.ceil(t.scaleSizeInUnits / d) < u.maxStep
                            ) {
                              t.unitScale = x.getValueOrDefault(
                                t.options.time.unitStepSize,
                                Math.ceil(t.scaleSizeInUnits / d)
                            ...
                            (u = w.units[++c]), (t.tickUnit = u.name);
                            var p = t.firstTick.diff(
                                t.getMomentStartOf(t.firstTick),
                                t.tickUnit,
                                !0
                              ),
                              f = t
                                .getMomentStartOf(
                                  t.lastTick.clone().add(1, t.tickUnit)
                                )
                                .diff(t.lastTick, t.tickUnit, !0);
                            (t.scaleSizeInUnits =
                              t.lastTick.diff(t.firstTick, t.tickUnit, !0) +
                              p +
                              f),
                              (t.displayFormat =
                                t.options.time.displayFormats[u.name]);
                          }
                        }
                        if (
                          (t.options.time.min
                            ? (e = t.getMomentStartOf(t.firstTick))
                            : ((t.firstTick = t.getMomentStartOf(t.firstTick)),
                              (e = t.firstTick)),
                          !t.options.time.max)
                        ) {
                          ...
                          m < 0
                            ? (t.lastTick = t.getMomentStartOf(
                                t.lastTick.add(1, t.tickUnit)
                              ))
                            : 0 <= m && (t.lastTick = g),
                            (t.scaleSizeInUnits = t.lastTick.diff(
                              t.firstTick,
                        ...
                        t.options.time.displayFormat &&
                          (t.displayFormat = t.options.time.displayFormat),
                          t.ticks.push(t.firstTick.clone());
                        for (var v = 1; v <= t.scaleSizeInUnits; ++v) {
                          var y = e.clone().add(v, t.tickUnit);
                          if (
                            t.options.time.max &&
                            0 <= y.diff(t.lastTick, t.tickUnit, !0)
                          )
                            break;
                          v % t.unitScale == 0 && t.ticks.push(y);
                        }
                        (0 !==
                          t.ticks[t.ticks.length - 1].diff(
                            t.lastTick,
                            t.tickUnit
                          ) ||
                          0 === t.scaleSizeInUnits) &&
                          (t.options.time.max
                            ? (t.ticks.push(t.lastTick.clone()),
                              (t.scaleSizeInUnits = t.lastTick.diff(
                                t.ticks[0],
                                t.tickUnit,
                                !0
                      ...
                      getPixelForValue: function (t, e, i) {
                        ...
                        if (
                          (void 0 !== e &&
                            void 0 !== i &&
                            (o = n.getLabelDiff(i, e)),
                          null === o &&
                            ((t && t.isValid) ||
                              (t = n.parseTime(n.getRightValue(t))),
                            t &&
                              t.isValid &&
                              t.isValid() &&
                              (o = t.diff(n.firstTick, n.tickUnit, !0))),
                          null !== o)
                        ) {
                          var r = 0 !== o ? o / n.scaleSizeInUnits : o;
                          if (n.isHorizontal()) {
                            var a =
                              (n.width - (n.paddingLeft + n.paddingRight)) * r +
                              n.paddingLeft;
                            return n.left + Math.round(a);
                          }
                          var s =
                            (n.height - (n.paddingTop + n.paddingBottom)) * r +
                            n.paddingTop;
                      ...
                      getValueForPixel: function (t) {
                        ...
                        return (
                          ...
                          e.firstTick
                            .clone()
                            .add(
                              a.duration(n, e.tickUnit).asSeconds(),
                              "seconds"
                            )
                        );
                      },
    ...
    (function (t) {
      ...
      function i(t, e, i) {
        ...
        return (
          ...
          r +
            ((l = i),
            u((s = [n, o]), s[0] < 0 ? l + Math.abs(s[0]) : l - s[0]) / c(r, a))
        );
      }
      function n(t, e, i, n) {
        if (100 === n) return n;
        var o,
          ...
          l = h(n, t);
        return i
          ? ((o = t[l - 1]), ((r = t[l]) - o) / 2 < n - o ? r : o)
          : e[l - 1]
          ? t[l - 1] +
            ((a = n - t[l - 1]), (s = e[l - 1]), Math.round(a / s) * s)
          : n;
      }
      function a(t, e, i) {
        var n;
      ...
      function s(t, e, i) {
        if (!e) return !0;
        i.xSteps[t] =
          u([i.xVal[t], i.xVal[t + 1]], e) / c(i.xPct[t], i.xPct[t + 1]);
      ...
      function p(t, e) {
        if (((e = j(e)), !Array.isArray(e) || !e.length))
      ...
      function k(t, e) {
        ...
        t.events = { tap: i || r, drag: n, fixed: o, snap: r, hover: a };
      }
      function S(t, e) {
        if (!1 !== e)
          if (!0 === e) {
            ...
            if (((t.tooltips = j(e)), t.tooltips.length !== t.handles))
              throw new Error(
      ...
      function Y(e) {
        var i,
          ...
          o = {
            connect: !(i = {
              ...
              cssPrefix: { r: !1, t: T },
              cssClasses: { r: !1, t: I },
              useRequestAnimationFrame: { r: !1, t: M },
            }),
            direction: "ltr",
            behaviour: "tap",
        ...
        return (
          (n.style = t[n.dir][n.ort]),
          (n.styleOposite = t[n.dir ? 0 : 1][n.ort]),
          n
        );
      }
      function _(t, h, r) {
        function a(t, e) {
          return !!e && V(t, h.cssClasses.connect);
        }
        function e(t, e) {
          return !!h.tooltips[e] && V(t.firstChild, h.cssClasses.tooltip);
        }
        function d(n, o, r) {
          function a(t, e, i) {
            return (
          ...
          return (
            ...
            $(
              ...
              0 === h.ort
                ...
                : h.cssClasses.pipsVertical
            ),
            Object.keys(n).forEach(function (t) {
              var e, i;
              ((i = n[(e = t)])[1] = i[1] && o ? o(i[0], i[1]) : i[1]),
                (s += "<div " + a(e, h.cssClasses.marker, i) + "></div>"),
                i[1] &&
                  (s +=
                    "<div " +
                    a(e, h.cssClasses.value, i) +
                    ">" +
                    r.to(i[0]) +
                    "</div>");
            }),
            ...
            s =
              ...
              g.forEach(function (t, e) {
                var i,
                  ...
                  h = g[e + 1];
                if (
                  ("steps" === f && (i = W.xNumSteps[e]),
                  i || (i = h - u),
                  !1 !== u && void 0 !== h)
                )
                  for (
                    i = Math.max(i, 1e-7), n = u;
                    n <= h;
                    n = (n + i).toFixed(7) / 1
                  ) {
                    for (
                      l = (a = (r = W.toStepping(n)) - b) / p,
                        c = a / (d = Math.round(l)),
                        o = 1;
                      o <= d;
                      o += 1
                    )
                      m[(b + o * c).toFixed(5)] = ["x", 0];
                    (s = -1 < g.indexOf(n) ? 1 : "steps" === f ? 2 : 0),
                      !e && v && (s = 0),
                      (n === h && y) || (m[r.toFixed(5)] = [n, s]),
                      (b = r);
                  }
              }),
              m),
        ...
        function s() {
          ...
          return 0 === h.ort ? t.width || M[e] : t.height || M[e];
        }
        function l(n, e, o, r) {
          var i = function (t) {
              return (
                ...
                !(e.classList
                  ...
                  ((t = (function (t, e) {
                    ...
                    return (
                      (e = e || U()),
                      (r || a) &&
                        ((i = t.clientX + e.x), (n = t.clientY + e.y)),
                      (s.pageOffset = e),
                      (s.points = [i, n]),
                      (s.cursor = r || a),
                      s
                  ...
                  !(n === L.start && void 0 !== t.buttons && 1 < t.buttons) &&
                    (!r.hover || !t.buttons) &&
                    ((t.calcPoint = t.points[h.ort]), void o(t, r))))
              );
              var e, i;
            },
            a = [];
              ...
              (100 *
                (t -
                  ...
                  /webkit.*Chrome.*Mobile/i.test(navigator.userAgent) &&
                    (r.x = 0),
                  i
                    ? n.top + r.y - o.clientTop
                    : n.left + r.x - o.clientLeft))) /
              s();
          ...
          Object.keys(H).forEach(function (t) {
            ...
            i === e &&
              H[t].forEach(function (t) {
                t.call(A, B.map(h.format.to), n, B.slice(), o || !1, F.slice());
              });
          });
        }
        function p(t, e) {
        ...
        function g(t, e) {
          var i = M.querySelector("." + h.cssClasses.active);
          null !== i && q(i, h.cssClasses.active),
            t.cursor &&
        ...
        function m(t, e) {
          ...
          if (
            ((document.documentElement.noUiListeners = n.concat(o, r)),
            t.cursor)
          ) {
            (document.body.style.cursor = getComputedStyle(t.target).cursor),
              1 < _.length && $(z, h.cssClasses.drag);
            var a = function () {
              return !1;
            };
        ...
        function o(t) {
          ...
          return (
            !1 !== i &&
            (h.events.snap || N(z, h.cssClasses.tap, h.animationDuration),
            w(i, e, !0, !0),
            x(),
            u("slide", i, !0),
            u("set", i, !0),
            u("change", i, !0),
            u("update", i, !0),
            void (h.events.snap && m(t, { handleNumbers: [i] })))
          );
        }
        function v(t) {
          var e = c(t.calcPoint),
        ...
        function y(t, e, i, n, o) {
          return (
            1 < _.length &&
              (n && 0 < e && (i = Math.max(i, t[e - 1] + h.margin)),
              o && e < _.length - 1 && (i = Math.min(i, t[e + 1] - h.margin))),
            1 < _.length &&
              h.limit &&
              (n && 0 < e && (i = Math.min(i, t[e - 1] + h.limit)),
              o && e < _.length - 1 && (i = Math.max(i, t[e + 1] - h.limit))),
            (i = W.getStep(i)),
            (r = i),
            (i = Math.max(Math.min(r, 100), 0)) !== t[e] && i
          );
          var r;
        }
        function b(t) {
        ...
        function x() {
          R.forEach(function (t) {
            var e = 50 < F[t] ? -1 : 1,
              i = 3 + (_.length + e * t);
            _[t].childNodes[0].style.zIndex = i;
          });
        }
        function w(t, e, i, n) {
          return (
            !1 !== (e = y(F, t, e, i, n)) &&
            ((function (t, e) {
              (F[t] = e), (B[t] = W.fromStepping(e));
              var i = function () {
                (_[t].style[h.style] = b(e)), k(t), k(t + 1);
              };
              window.requestAnimationFrame && h.useRequestAnimationFrame
        ...
        function k(t) {
          if (P[t]) {
            ...
            0 !== t && (e = F[t - 1]),
              t !== P.length - 1 && (i = F[t]),
              (P[t].style[h.style] = b(e)),
              (P[t].style[h.styleOposite] = b(100 - i));
          }
        }
        function S(t, e) {
          null !== t &&
        ...
        function C(t, e) {
          ...
          (e = void 0 === e || !!e),
            i.forEach(S),
            h.animate && !n && N(z, h.cssClasses.tap, h.animationDuration),
            R.forEach(function (t) {
              w(t, F[t], !0, !1);
            }),
            x(),
        ...
        var M,
          ...
          O,
          E,
          L = window.navigator.pointerEnabled
        ...
        return (
          $((E = z), h.cssClasses.target),
          0 === h.dir ? $(E, h.cssClasses.ltr) : $(E, h.cssClasses.rtl),
          0 === h.ort
            ? $(E, h.cssClasses.horizontal)
            : $(E, h.cssClasses.vertical),
          (M = V(E, h.cssClasses.base)),
          (function (t, e) {
            (_ = []), (P = []).push(a(e, t[0]));
            for (var i = 0; i < h.handles; i++)
              _.push(
                ((n = i),
                V(
                  (o = V(e, h.cssClasses.origin)),
                  h.cssClasses.handle
                ).setAttribute("data-handle", n),
                o)
              ),
                (R[i] = i),
                P.push(a(e, t[i + 1]));
          ...
          (A = {
            destroy: function () {
              for (var t in h.cssClasses)
                h.cssClasses.hasOwnProperty(t) && q(z, h.cssClasses[t]);
            ...
            updateOptions: function (e, t) {
              ...
              n.forEach(function (t) {
                ...
                (o.spectrum.direction = W.direction),
                (W = o.spectrum),
                (h.margin = o.margin),
                (h.limit = o.limit),
                (F = []),
          ...
          (O = h.events).fixed ||
            _.forEach(function (t, e) {
              l(L.start, t.children[0], m, { handleNumbers: [e] });
            }),
          O.tap && l(L.start, M, o, {}),
          O.hover && l(L.move, M, v, { hover: !0 }),
          O.drag &&
            P.forEach(function (t, e) {
              if (!1 !== t && 0 !== e && e !== P.length - 1) {
                var i = _[e - 1],
                  n = _[e],
                  o = [t];
                $(t, h.cssClasses.draggable),
                  O.fixed && (o.push(i.children[0]), o.push(n.children[0])),
          ...
          h.tooltips &&
            ...
            I("update", function (t, e, i) {
              if (D[e]) {
                var n = t[e];
                !0 !== h.tooltips[e] && (n = h.tooltips[e].to(i[e])),
                  (D[e].innerHTML = n);
              }
            })),
          A
    ...
    (function (s, l, t) {
      (s.fn.easyEmbed = function (t) {
        var i = this,
          e = /iPad|iPhone|iPod/.test(navigator.userAgent),
          n = i.data("easy-embed").split(":"),
          r = s.extend(
            {
              id: i.data("id") || n[1] || "ScMzIvxBSi4",
              provider: i.data("provider") || n[0] || "youtube",
              width: i.data("width") || 16,
              height: i.data("height") || 9,
              thumbnail: i.data("thumbnail") || "auto",
              controls: i.data("controls") || !1,
              showinfo: i.data("showinfo") || !1,
              color: i.data("color") || "00adef",
              title: i.data("title") || !1,
              byline: i.data("byline") || !1,
              portrait: i.data("portrait") || !1,
            },
            t
          ),
          o = function () {
            i.css("height", (i.width() / r.width) * r.height);
          },
          a = function () {
            i.html(
              s("<iframe>")
                .attr(
                  ...
                  (function () {
                    switch (r.provider.toLowerCase()) {
                      ...
                      case "twitch":
                        return "//player.twitch.tv/?channel=" + r.id;
                    }
                  })()
                )
                .attr("width", "100%")
          ...
          e
            ...
            : (!(function (i) {
                ...
                (e = t),
                  i.css(
                    "background",
                    "black url(" + e + ") 50% 50% / cover no-repeat"
                  );
              }),
              i
                .find("*")
        ...
        s(t).ready(function () {
          0 < s("[data-easy-embed]").length &&
            s("[data-easy-embed]").each(function () {
              s(this).easyEmbed();
            });
        });
