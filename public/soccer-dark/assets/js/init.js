$(document).ready(function () {
  (function ($) {
    ...
    var $slick_player_achievements_carousel = $(
      ".js-alc-achievements-carousel"
    );
    ...
    var Core = {
        ...
        if ($slick_video_carousel.exists()) {
          ...
          $(".category-filter--carousel .category-filter__link--reset").on(
            ...
            function (e) {
              $slick_video_carousel.slick("slickUnfilter");
              $(
                ".category-filter--carousel .category-filter__link"
              ).removeClass("category-filter__link--active");
              $(this).addClass("category-filter__link--active");
              filtered = false;
              e.preventDefault();
        ...
        if ($slick_featured_slider.exists()) {
          ...
          $(".category-filter--featured .category-filter__link--reset").on(
            ...
            function (e) {
              $slick_featured_slider.slick("slickUnfilter");
              $(
                ".category-filter--featured .category-filter__link"
              ).removeClass("category-filter__link--active");
              $(this).addClass("category-filter__link--active");
              filtered2 = false;
              e.preventDefault();
      ...
      ChartJs: function () {
        ...
        if ($chart_games_history_soccer.exists()) {
          ...
          document.getElementById(
            "gamesHistoryLegendSoccer"
          ).innerHTML = gamesHistory2.generateLegend();
        }
        ...
        if ($chart_games_history_esports.exists()) {
          ...
          document.getElementById(
            "gamesHistoryLegendEsports"
          ).innerHTML = gamesHistoryEsports.generateLegend();
        }
        ...
        if ($chart_points_history_soccer.exists()) {
          ...
          document.getElementById(
            "gamesPoinstsLegendSoccer"
          ).innerHTML = gamesHistory4.generateLegend();
        }
        ...
        if ($chart_points_history_football.exists()) {
          ...
          document.getElementById(
            "gamesPoinstsLegendFootball"
          ).innerHTML = gamesHistory5.generateLegend();
        }
        ...
        if ($chart_yearly_history_esports.exists()) {
          ...
          document.getElementById(
            "gamesYearlyLegendEsports"
          ).innerHTML = gamesHistory6.generateLegend();
        }
        ...
        if ($chart_doughnut_soccer1.exists()) {
          ...
          var gamesHistorySoccer1 = new Chart(
            ctxdoughnut_soccer_1,
            dataSoccer1
          );

          document.getElementById(
            "chartDoughnutLegendSoccer1"
          ).innerHTML = gamesHistorySoccer1.generateLegend();
        }
        ...
        if ($chart_doughnut_soccer2.exists()) {
          ...
          var gamesHistorySoccer2 = new Chart(
            ctxdoughnut_soccer_2,
            dataSoccer2
          );

          document.getElementById(
            "chartDoughnutLegendSoccer2"
          ).innerHTML = gamesHistorySoccer2.generateLegend();
        }
        ...
        if ($chart_event_cols.exists()) {
          ...
          document.getElementById(
            "gamesHistoryLegend"
          ).innerHTML = gamesHistory9.generateLegend();
        }
      },
      ...
      GoogleMap: function () {
        ...
        if ($gmap.exists()) {
          $gmap.each(function () {
            ...
            var mapTypeControlBoolean =
              mapTypeControl == "false" ? false : true;
